...
export default function Home() {
  ...
  const [editForm, setEditForm] = useState({ title: "", titleEn: "", description: "", descriptionEn: "", city: "Makkah", category: "mosque" });
